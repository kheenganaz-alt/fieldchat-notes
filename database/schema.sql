...
create table if not exists public.settings (
  ...
  "fakeContactName" text not null default 'Mom',
  vibration boolean not null default true,
  "autoResume" boolean not null default true,
  "pinLock" boolean not null default false,
  "pinCode" text,
  "themeAccent" text not null default 'shopit',
  "timestampPrecision" text not null default 'seconds',
  "autoOpenTimestamp" boolean not null default true,
  "voiceNotesEnabled" boolean not null default true,
  "defaultExportFormat" text not null default 'pdf',
  "includePhotosInExports" boolean not null default true,
  "autoShareExports" boolean not null default true,
  "offlineCache" boolean not null default true,
  "autoSync" boolean not null default true,
  "permissionCamera" text not null default 'ask_when_used',
  "permissionMicrophone" text not null default 'ask_when_used',
  "permissionLocation" text not null default 'ask_when_used',
  "quickEventSettings" jsonb not null default '{}'::jsonb,
  "createdAt" timestamptz not null,
  "updatedAt" timestamptz not null,
  "syncedAt" timestamptz
);
